...
namespace Proje.Controllers
{
    public class SliderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SilderId,Baslik,Aciklama,ResimURL")] Slider slider,HttpPostedFileBase ResimURL)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SilderId,Baslik,Aciklama,ResimURL")] Slider slider,HttpPostedFileBase ResimURL,int id)
        {
            if (ModelState.IsValid)
            {
                var s=db.Slider.Where(x=>x.SilderId==id).SingleOrDefault(); 
                if (ResimURL != null)
                {
