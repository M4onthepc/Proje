...
namespace Proje.Controllers
{
    public class İletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "İletisimId,Adres,Tel,Fax,Whatsapp,Facebook,Twitter,Instagram")] İletisim İletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "İletisimId,Adres,Tel,Fax,Whatsapp,Facebook,Twitter,Instagram")] İletisim İletisim)
        {
            if (ModelState.IsValid)
            {
